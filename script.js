...
const newTaskInput = document.getElementById("new-task"); //field for new task
const addTaskButton = document.getElementById("addTask"); //add/update task
const incompleteTaskList = document.getElementById("items"); //incomplete tasks
const completeTaskList = document.querySelector(".complete-list ul"); //completed tasks
